...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/NTC_test1.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=NTC.c ../Common_files/SHT21.c ../Common_files/UART_utils.c ../Common_files/i2c_functions.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/NTC.o ${OBJECTDIR}/_ext/1444887758/SHT21.o ${OBJECTDIR}/_ext/1444887758/UART_utils.o ${OBJECTDIR}/_ext/1444887758/i2c_functions.o
POSSIBLE_DEPFILES=${OBJECTDIR}/NTC.o.d ${OBJECTDIR}/_ext/1444887758/SHT21.o.d ${OBJECTDIR}/_ext/1444887758/UART_utils.o.d ${OBJECTDIR}/_ext/1444887758/i2c_functions.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/NTC.o ${OBJECTDIR}/_ext/1444887758/SHT21.o ${OBJECTDIR}/_ext/1444887758/UART_utils.o ${OBJECTDIR}/_ext/1444887758/i2c_functions.o

# Source Files
SOURCEFILES=NTC.c ../Common_files/SHT21.c ../Common_files/UART_utils.c ../Common_files/i2c_functions.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/NTC_test1.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/NTC.o: NTC.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/NTC.o.d 
	@${RM} ${OBJECTDIR}/NTC.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  NTC.c  -o ${OBJECTDIR}/NTC.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/NTC.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -I"../Common_files" -msmart-io=1 -Wall -msfr-warn=off  
...
${OBJECTDIR}/NTC.o: NTC.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/NTC.o.d 
	@${RM} ${OBJECTDIR}/NTC.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  NTC.c  -o ${OBJECTDIR}/NTC.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/NTC.o.d"        -g -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -I"../Common_files" -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/NTC.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
dist/${CND_CONF}/${IMAGE_TYPE}/NTC_test1.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}\\xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/NTC_test1.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf  
