...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/BPW34_test2.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=../Common_files/SHT21.c ../Common_files/UART_utils.c ../Common_files/i2c_functions.c BPW34_test2.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1444887758/SHT21.o ${OBJECTDIR}/_ext/1444887758/UART_utils.o ${OBJECTDIR}/_ext/1444887758/i2c_functions.o ${OBJECTDIR}/BPW34_test2.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1444887758/SHT21.o.d ${OBJECTDIR}/_ext/1444887758/UART_utils.o.d ${OBJECTDIR}/_ext/1444887758/i2c_functions.o.d ${OBJECTDIR}/BPW34_test2.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1444887758/SHT21.o ${OBJECTDIR}/_ext/1444887758/UART_utils.o ${OBJECTDIR}/_ext/1444887758/i2c_functions.o ${OBJECTDIR}/BPW34_test2.o

# Source Files
SOURCEFILES=../Common_files/SHT21.c ../Common_files/UART_utils.c ../Common_files/i2c_functions.c BPW34_test2.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/BPW34_test2.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/BPW34_test2.o: BPW34_test2.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/BPW34_test2.o.d 
	@${RM} ${OBJECTDIR}/BPW34_test2.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  BPW34_test2.c  -o ${OBJECTDIR}/BPW34_test2.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/BPW34_test2.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -I"../Common_files" -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/BPW34_test2.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/BPW34_test2.o: BPW34_test2.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/BPW34_test2.o.d 
	@${RM} ${OBJECTDIR}/BPW34_test2.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  BPW34_test2.c  -o ${OBJECTDIR}/BPW34_test2.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/BPW34_test2.o.d"        -g -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -I"../Common_files" -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/BPW34_test2.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
dist/${CND_CONF}/${IMAGE_TYPE}/BPW34_test2.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}\\xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/BPW34_test2.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf  
